...
parser.add_argument('--seed', type=int, default=57, help='random seed to use. Default=123')
parser.add_argument('--data_train', type=str, default=r'C:/Users/HP-VICTUS/Documents/Masters/PairLIE/PairLIE-training-dataset/')
parser.add_argument('--rgb_range', type=int, default=1, help='maximum value of RGB')
parser.add_argument('--save_folder', default=r'C:/Users/HP-VICTUS/Documents/Masters/PairLIE/weights2/', help='Location to save checkpoint models')
parser.add_argument('--output_folder', default=r'C:/Users/HP-VICTUS/Documents/Masters/PairLIE/results/', help='Location to save checkpoint models')
